    ...
    return hotels.map((elem, i) => {
        return (<div key={i} id={i} className="maindiv white tc center sboxAnim Submit bg-transparent shadow-5 ba unconmedia">
            ...
            <div className="ownersname w-100 h-100 dt">
                ...
                <h1 className="capitalize fontmedianame">{elem.nom}</h1>
                    <h1 className="capitalize fontmedianame">{elem.prenom}</h1>
                </div>
            </div>
            <div className="addr w-100 h-100 dt">
            <h1 className="dtc v-mid capitalize fontmediaregion">{elem.region}</h1>
            </div>
